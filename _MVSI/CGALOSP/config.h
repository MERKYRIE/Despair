...
#include <../BOB/version.hpp>

#include <../CGALOSP/version.h>
...
#if CGAL_HEADER_ONLY
#  include <../CGALOSP/Installation/internal/enable_third_party_libraries.h>
#else
#  include <../CGALOSPcompiler_config.h>
#endif

#if BOOST_MSVC && CGAL_TEST_SUITE
#  include <../CGALOSPTestsuite/vc_debug_hook.h>
#endif
...
#include <../CGALOSP/functional.h>

//----------------------------------------------------------------------//
//  auto-link the CGAL library on platforms that support it
//----------------------------------------------------------------------//

#include <../CGALOSP/auto_link/CGAL.h>
...
#endif // not BOOST_MSVC
/// @}
#include <../CGALOSP/license/lgpl.h>
