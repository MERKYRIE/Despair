...
namespace NBlindness::NEngine::NLevel{
    void CSpace::FInitialize(){
        std::uint32_t LFloor{GAtlas.FTexture("\\sfloor4_5.png")};
        std::uint32_t LWall000{GAtlas.FTexture("\\twall2_3.png")};
        std::uint32_t LWall010{GAtlas.FTexture("\\twall2_5.png")};
        std::uint32_t LWall020{GAtlas.FTexture("\\twall2_6.png")};
        std::uint32_t LWall110{GAtlas.FTexture("\\twall5_3.png")};
        std::uint32_t LWall210{GAtlas.FTexture("\\uwall1_2.png")};
        std::uint32_t LCeiling{GAtlas.FTexture("\\plat_top1.png")};
