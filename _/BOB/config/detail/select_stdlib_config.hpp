...
#  define BOOST_STDLIB_CONFIG "<../BOB/config/stdlib/stlport.hpp"
...
// Comeau STL:
#define BOOST_STDLIB_CONFIG "<../BOB/config/stdlib/libcomo.hpp"

#elif defined(__STD_RWCOMPILER_H__) || defined(_RWSTD_VER)
// Rogue Wave library:
#  define BOOST_STDLIB_CONFIG "<../BOB/config/stdlib/roguewave.hpp"

#elif defined(_LIBCPP_VERSION)
// libc++
#  define BOOST_STDLIB_CONFIG "<../BOB/config/stdlib/libcpp.hpp"

#elif defined(__GLIBCPP__) || defined(__GLIBCXX__)
// GNU libstdc++ 3
#  define BOOST_STDLIB_CONFIG "<../BOB/config/stdlib/libstdcpp3.hpp"

#elif defined(__STL_CONFIG_H)
// generic SGI STL
#  define BOOST_STDLIB_CONFIG "<../BOB/config/stdlib/sgi.hpp"

#elif defined(__MSL_CPP__)
// MSL standard lib:
#  define BOOST_STDLIB_CONFIG "<../BOB/config/stdlib/msl.hpp"

#elif defined(__IBMCPP__) && defined(__COMPILER_VER__) && defined(__MVS__)
// IBM z/OS XL C/C++
#  define BOOST_STDLIB_CONFIG "<../BOB/config/stdlib/xlcpp_zos.hpp"

#elif defined(__IBMCPP__)
// take the default VACPP std lib
#  define BOOST_STDLIB_CONFIG "<../BOB/config/stdlib/vacpp.hpp"

#elif defined(MSIPL_COMPILE_H)
// Modena C++ standard library
#  define BOOST_STDLIB_CONFIG "<../BOB/config/stdlib/modena.hpp"

#elif (defined(_YVALS) && !defined(__IBMCPP__)) || defined(_CPPLIB_VER)
// Dinkumware Library (this has to appear after any possible replacement libraries):
#  define BOOST_STDLIB_CONFIG "../BOB/config/stdlib/dinkumware.hpp"
...
//
#  include "<../BOB/config/stdlib/stlport.hpp"
#  include "<../BOB/config/stdlib/libcomo.hpp"
#  include "<../BOB/config/stdlib/roguewave.hpp"
#  include "<../BOB/config/stdlib/libcpp.hpp"
#  include "<../BOB/config/stdlib/libstdcpp3.hpp"
#  include "<../BOB/config/stdlib/sgi.hpp"
#  include "<../BOB/config/stdlib/msl.hpp"
#  include "<../BOB/config/stdlib/xlcpp_zos.hpp"
#  include "<../BOB/config/stdlib/vacpp.hpp"
#  include "<../BOB/config/stdlib/modena.hpp"
#  include "<../BOB/config/stdlib/dinkumware.hpp"
#endif
