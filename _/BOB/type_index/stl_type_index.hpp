...
#include <../BOB/type_index/type_index_facade.hpp>

// MSVC is capable of calling typeid(T) even when RTTI is off
#if defined(BOOST_NO_RTTI) && !defined(BOOST_MSVC)
#error "File ../BOB/type_index/stl_type_index.ipp is not usable when typeid() is not available."
#endif
...
#else
#   include <../BOB/container_hash/hash.hpp>
#endif

#if (defined(__EDG_VERSION__) && __EDG_VERSION__ < 245) \
        || (defined(__sgi) && defined(_COMPILER_VERSION) && _COMPILER_VERSION <= 744)
#   include <../BOB/type_traits/is_signed.hpp>
#   include <../BOB/type_traits/make_signed.hpp>
