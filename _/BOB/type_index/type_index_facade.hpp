...
public:
    ...
    /// \note Derived class header \b must include <../BOB/container_hash/hash.hpp>, \b unless this function is redefined in
...
/// \note <../BOB/container_hash/hash.hpp> has to be included if this function is used.
template <class Derived, class TypeInfo>
