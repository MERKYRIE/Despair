...
#include <../BOB/config.hpp>   // for BOOST_STATIC_CONSTANT
#include <../BOB/integer.hpp>  // for boost::uint_t
...
//
// ../BOB/integer/integer_mask.hpp:93:35: warning: use of C99 long long integer constant
//
