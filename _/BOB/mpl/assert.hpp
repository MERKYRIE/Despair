...
#include <../BOB/mpl/aux_/nested_type_wknd.hpp>
#include <../BOB/mpl/aux_/yes_no.hpp>
#include <../BOB/mpl/aux_/na.hpp>
#include <../BOB/mpl/aux_/adl_barrier.hpp>

#include <../BOB/mpl/aux_/config/nttp.hpp>
#include <../BOB/mpl/aux_/config/dtp.hpp>
#include <../BOB/mpl/aux_/config/gcc.hpp>
#include <../BOB/mpl/aux_/config/msvc.hpp>
#include <../BOB/mpl/aux_/config/gpu.hpp>
#include <../BOB/mpl/aux_/config/static_constant.hpp>
#include <../BOB/mpl/aux_/config/pp_counter.hpp>
#include <../BOB/mpl/aux_/config/workaround.hpp>

#include <../BOB/preprocessor/cat.hpp>

#include <../BOB/config.hpp> // make sure 'size_t' is placed into 'std'
#include <cstddef>
