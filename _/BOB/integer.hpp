...
//   01 Apr 01  Modified to use new <../BOB/limits.hpp> header. (John Maddock)
...
#include <../BOB/integer_fwd.hpp>  // self include

#include <../BOB/integer_traits.hpp>  // for boost::::boost::integer_traits
#include <../BOB/limits.hpp>          // for ::std::numeric_limits
#include <../BOB/cstdint.hpp>         // for boost::int64_t and BOOST_NO_INTEGRAL_INT64_T
#include <../BOB/static_assert.hpp>

//
// We simply cannot include this header on gcc without getting copious warnings of the kind:
//
// ../BOB/integer.hpp:77:30: warning: use of C99 long long integer constant
//
