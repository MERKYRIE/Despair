...
#include <../BOB/type_index.hpp>

#include <../BOB/variant/detail/config.hpp>
#include <../BOB/mpl/aux_/value_wknd.hpp>

#include <../BOB/variant/variant_fwd.hpp>
#include <../BOB/variant/detail/backup_holder.hpp>
#include <../BOB/variant/detail/enable_recursive_fwd.hpp>
#include <../BOB/variant/detail/forced_return.hpp>
#include <../BOB/variant/detail/initializer.hpp>
#include <../BOB/variant/detail/make_variant_list.hpp>
#include <../BOB/variant/detail/over_sequence.hpp>
#include <../BOB/variant/detail/visitation_impl.hpp>
#include <../BOB/variant/detail/hash_variant.hpp>
#include <../BOB/variant/detail/std_hash.hpp>

#include <../BOB/variant/detail/move.hpp>

#include <../BOB/detail/reference_content.hpp>
#include <../BOB/blank.hpp>
#include <../BOB/integer/common_factor_ct.hpp>
#include <../BOB/static_assert.hpp>
#include <../BOB/preprocessor/cat.hpp>
#include <../BOB/preprocessor/repeat.hpp>
#include <../BOB/type_traits/aligned_storage.hpp>
#include <../BOB/type_traits/alignment_of.hpp>
#include <../BOB/type_traits/add_const.hpp>
#include <../BOB/type_traits/has_nothrow_constructor.hpp>
#include <../BOB/type_traits/has_nothrow_copy.hpp>
#include <../BOB/type_traits/is_nothrow_move_assignable.hpp>
#include <../BOB/type_traits/is_nothrow_move_constructible.hpp>
#include <../BOB/type_traits/is_const.hpp>
#include <../BOB/type_traits/is_same.hpp>
#include <../BOB/type_traits/is_rvalue_reference.hpp>
#include <../BOB/type_traits/is_constructible.hpp>
#include <../BOB/type_traits/add_lvalue_reference.hpp>
#include <../BOB/type_traits/declval.hpp>
#include <../BOB/core/no_exceptions_support.hpp>
#include <../BOB/core/enable_if.hpp>
#include <../BOB/variant/recursive_wrapper_fwd.hpp>
#include <../BOB/variant/static_visitor.hpp>

#include <../BOB/mpl/assert.hpp>
#include <../BOB/mpl/begin_end.hpp>
#include <../BOB/mpl/bool.hpp>
#include <../BOB/mpl/deref.hpp>
#include <../BOB/mpl/empty.hpp>
#include <../BOB/mpl/eval_if.hpp>
#include <../BOB/mpl/find_if.hpp>
#include <../BOB/mpl/fold.hpp>
#include <../BOB/mpl/front.hpp>
#include <../BOB/mpl/identity.hpp>
#include <../BOB/mpl/if.hpp>
#include <../BOB/mpl/insert_range.hpp>
#include <../BOB/mpl/int.hpp>
#include <../BOB/mpl/is_sequence.hpp>
#include <../BOB/mpl/iterator_range.hpp>
#include <../BOB/mpl/iter_fold_if.hpp>
#include <../BOB/mpl/list.hpp>
#include <../BOB/mpl/logical.hpp>
#include <../BOB/mpl/max_element.hpp>
#include <../BOB/mpl/next.hpp>
#include <../BOB/mpl/not.hpp>
#include <../BOB/mpl/pair.hpp>
#include <../BOB/mpl/protect.hpp>
#include <../BOB/mpl/push_front.hpp>
#include <../BOB/mpl/same_as.hpp>
#include <../BOB/mpl/size_t.hpp>
#include <../BOB/mpl/sizeof.hpp>
#include <../BOB/mpl/transform.hpp>
...
#   include <../BOB/mpl/eval_if.hpp>
#   include <../BOB/mpl/equal_to.hpp>
#   include <../BOB/mpl/identity.hpp>
#   include <../BOB/mpl/int.hpp>
#   include <../BOB/mpl/if.hpp>
#   include <../BOB/mpl/less.hpp>
#   include <../BOB/mpl/long.hpp>
#   include <../BOB/mpl/O1_size.hpp>
#endif
...
#include <../BOB/variant/detail/variant_io.hpp>
